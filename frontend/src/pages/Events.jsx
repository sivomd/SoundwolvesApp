...
export const Events = () => {
  ...
  const events = [
    {
      id: 1,
      title: 'Diwali Nights NYC: Bollywood Royale',
      artist: 'DJ Rekha',
      venue: 'Brooklyn Bowl',
      city: 'New York',
      date: 'Nov 15, 2024',
    ...
    {
      id: 6,
      title: 'Desi Remix Festival 2024',
      artist: 'DJ Navv',
      venue: 'Liberty Hall',
      city: 'Jersey City',
      date: 'Dec 14, 2024',
